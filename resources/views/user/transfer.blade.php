      ...
      <div class="row">
        <div class="col-md-8" style="margin: auto;">
          ...
          <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="{{ url('/transaction/transfer') }}" id="transactionForm">
              {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <div class="col-10" style="margin: auto;">
                        <div class="form-group">
                            <label for=accountTo>To account</label>
                            <select class="form-control" name="accountTo" id="accountTo" disabled >
                                <option value="0">Choose account</option>
                            </select>
                        </div>
                    </div> 
                    <div class="col-10" style="margin: auto;">   
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="amount" placeholder="$" id="amount" disabled data-inputmask="'mask': '999999999'" >
                        </div>
                    </div>    
                </div>
                <!-- /.card-body -->
    ...
    <script>
      ...
      $(document).ready(function(){
            ...
            $('#account').change(function(){
              ...
              if(value==0)
              {
                $('#accountTo').html('<option value="0">Choose account</option>');
      ...
      function checkFields()
        {
          if($("#account").val()==0 || $("#accountTo").val()==0)
          {
            $("#transactionBut").prop('disabled', true);
